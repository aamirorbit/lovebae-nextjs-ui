      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <span style={{ fontSize: 32, fontWeight: 700, color: '#1a1a1a' }}>Love</span>
            <span style={{ fontSize: 32, fontWeight: 700, color: '#E7000B' }}>bae</span>
            <span style={{ fontSize: 24, color: '#999', marginLeft: 16 }}>Blog</span>
          </div>
          <div style={{ fontSize: 20, color: '#666' }}>lovebae.app/blog</div>
        </div>
      </div>
    ),
    { ...size }
