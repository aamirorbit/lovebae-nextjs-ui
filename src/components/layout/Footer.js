      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm">
            ...
            <Link href="/creators" className="text-gray-600 hover:text-red-500 transition-colors">
              Creators
            </Link>
            ...
            <Link href="/cookies" className="text-gray-600 hover:text-red-500 transition-colors">
              Cookies
            </Link>
          </div>
